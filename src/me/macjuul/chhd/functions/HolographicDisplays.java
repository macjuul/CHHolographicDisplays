...
public class HolographicDisplays {
    ...
    @api
    public static class chhd_create_hologram extends AbstractFunction {
        ...
        public Construct exec(Target t, Environment environment, Construct... args) throws ConfigRuntimeException {
            ...
            if(hololist.containsKey(id)) {
                throw new CRECastException("That hologram ID already exists!", t);
            }
    ...
    @api
    public static class chhd_remove_hologram extends AbstractFunction {
        @SuppressWarnings("unchecked")
        public Class<? extends CREThrowable>[] thrown() {
            return new Class[] {
                    CRECastException.class,
        ...
        public Construct exec(Target t, Environment environment, Construct... args) throws ConfigRuntimeException {
            ...
            if(!hololist.containsKey(id)) {
                throw new CRENotFoundException("That hologram ID does not exists!", t);
            }
    ...
    @api
    public static class chhd_list_holograms extends AbstractFunction {
        @SuppressWarnings("unchecked")
        public Class<? extends CREThrowable>[] thrown() {
            return new Class[] {
                    CRECastException.class
    ...
    @api
    public static class chhd_hologram_addline extends AbstractFunction {
        @SuppressWarnings("unchecked")
        public Class<? extends CREThrowable>[] thrown() {
            return new Class[] {
                    CRECastException.class
    ...
    @api
    public static class chhd_hologram_removeline extends AbstractFunction {
        @SuppressWarnings("unchecked")
        public Class<? extends CREThrowable>[] thrown() {
            return new Class[] {
                    CRECastException.class
        ...
        public Construct exec(Target t, Environment environment, Construct... args) throws ConfigRuntimeException {
            ...
            if((line < 1) || (line > holo.size())) {
                throw new CREIndexOverflowException("Invalid line number", t);
            }
    ...
    @api
    public static class chhd_hologram_setline extends AbstractFunction {
        @SuppressWarnings("unchecked")
        public Class<? extends CREThrowable>[] thrown() {
            return new Class[] {
                    CRECastException.class
    ...
    @api
    public static class chhd_hologram_insertline extends AbstractFunction {
        @SuppressWarnings("unchecked")
        public Class<? extends CREThrowable>[] thrown() {
            return new Class[] {
                    CRECastException.class
    ...
    @api
    public static class chhd_get_hologram_loc extends AbstractFunction {
        @SuppressWarnings("unchecked")
        public Class<? extends CREThrowable>[] thrown() {
            return new Class[] {
                    CRECastException.class
    ...
    @api
    public static class chhd_set_hologram_loc extends AbstractFunction {
        @SuppressWarnings("unchecked")
        public Class<? extends CREThrowable>[] thrown() {
            return new Class[] {
                    CRECastException.class
    ...
    @api
    public static class chhd_hologram_timestamp extends AbstractFunction {
        @SuppressWarnings("unchecked")
        public Class<? extends CREThrowable>[] thrown() {
            return new Class[] {
                    CRECastException.class
    ...
    @api
    public static class chhd_hologram_visibility extends AbstractFunction {
        @SuppressWarnings("unchecked")
        public Class<? extends CREThrowable>[] thrown() {
            return new Class[] {
                    CRECastException.class,
            ...
            if(Integer.valueOf(args.length).equals(Integer.valueOf(1))) {
                ...
                for(Player p : Bukkit.getOnlinePlayers()) {
                    if(vbm.isVisibleTo(p)) {
                        list.push(new CString(p.getName(), t), t);
                    }
                }
                return list;
            }
            if(Static.isNull(args[1])) {
                ...
                for(int i = 0; i < arr.size(); i++) {
                    ...
                    if(p != null) {
                        ...
                        throw new CREPlayerOfflineException("The specified players (" + arr.get(i, t).val() + ") is not online", t);
                    }
                }
            }
            return CVoid.VOID;
